(function(i) {
    ...
    function a(r) {
        i.fn.cycle.debug && f(r)
    }

    function f() {
        window.console && console.log && console.log("[cycle] " + Array.prototype.join.call(arguments, " "))
    }
    i.expr[":"].paused = function(r) {
        return r.cyclePause
    };
    ...
    i.fn.cycle.commonReset = function(x, u, v, s, t, r) {
        ...
        if (typeof v.cssBefore.opacity == "undefined") {
    ...
    i.fn.cycle.custom = function(D, x, r, u, w, s) {
        ...
        var z = function() {
            y.animate(r.animIn, t, v, function() {
                u()
            })
        };
    ...
    i.fn.cycle.transitions = {
        fade: function(s, t, r) {
			...
			// ######################## INIZIO DELLA PERSONALIZZAZIONE DEL CODICE ######################### 
			
            if (i("#giardino").css("display") == "block") {
                i("#titleSite").fadeIn()
            } else {
                i("#titleSite").hide()
            }
